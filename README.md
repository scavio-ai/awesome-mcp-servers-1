...
- **[Scavio](https://github.com/scavio-ai/scavio-mcp)** - Real-time search & extract across Google, YouTube, Amazon, Walmart, Reddit, TikTok, and Instagram as clean JSON for AI agents. Hosted at [mcp.scavio.dev](https://mcp.scavio.dev) or run locally via `npx`.
