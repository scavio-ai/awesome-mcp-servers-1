...
- **[Scavio](https://github.com/scavio-ai/scavio-mcp)** - Real-time structured web data across 32 platforms as clean JSON for AI agents: Google (SERP, News, Maps, Shopping, Trends, Flights, Hotels, AI Mode), YouTube, Amazon, Walmart, eBay, Target, TikTok, TikTok Shop, Instagram, LinkedIn, X, Reddit, Zillow, Indeed, Glassdoor, SEC EDGAR and more, plus extract-any-URL to Markdown. Hosted at [mcp.scavio.dev](https://mcp.scavio.dev) or run locally via `npx`.
